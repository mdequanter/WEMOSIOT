# Follow http://nilhcem.com/iot/cloud-iot-core-with-the-esp32-and-arduino  to create a key on google cloud console, use these keys to generate a JWT

#Installation
# pip install -r requirementsjwt.txt
